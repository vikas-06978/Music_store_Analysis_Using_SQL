...
-- sum of invoice totals. Return both the city names & sum of all invoice totals.
...
-- Q1: Write query to return the email, first_name, last_name, & Genre of all Rock Music Listeners.
